...
# Discussion 6: Property Based Testing and Observers

Welcome to the sixth discussion! This week you'll learn more about writing property based tests and using the observer pattern.
...
Download the starter code [here](https://github.com/umass-compsci-220/public-materials/raw/main/discussion/06-property-testing-observers.zip). Make sure to submit this to gradescope, ask your lab leaders to help you if you are unsure of how. We'll also show the process in the first lab.

The solution file will be posted [here](https://github.com/umass-compsci-220/public-materials/raw/main/discussion/06-property-testing-observers-solution.ts) after lab.

...
# Discussion 8: Extending Libraries and Generators

Welcome to the eighth discussion! This week you'll learn more extending libraries, and about generators.
...
Download the starter code [here](https://github.com/umass-compsci-220/public-materials/raw/main/discussion/08-extending-libraries-generators.zip). Make sure to submit this to gradescope, ask your lab leaders to help you if you are unsure of how. We'll also show the process in the first lab.

The solution file will be posted [here](https://github.com/umass-compsci-220/public-materials/raw/main/discussion/08-extending-libraries-generators-solution.ts) after lab.
